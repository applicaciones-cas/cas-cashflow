...
public class PaymentRequest extends Transaction {
    ...
    if ("success".equals(this.poJSON.get("result"))) {
      ...
      if (this.pnEditMode == 0 || this.pnEditMode == 2) {
        ...
        System.out.println("Edit mode before save record : " + this.pnEditMode);
        this.poJSON = this.poMaster.saveRecord();
         System.out.println("pbwithparent before if : " + this.pbWthParent);
        if ("error".equals(this.poJSON.get("result"))) {
            System.out.println("pbwithparent before if : " + this.pbWthParent);
          if (!this.pbWthParent)
              System.out.println("pbwithparent after if : " + this.pbWthParent);
