...
//    static String testFilePath = "D:/GGC_Maven_Systems/config/metadata/new/Model_Disbursement_Detail.xml";
//
//    @BeforeClass
...
//                Logger.getLogger(exportXMLTest.class.getName()).log(Level.SEVERE, null, ex);
...
//            Assert.assertTrue("XML content missing table name.", content.contains("<table>Disbursement_Detail</table>"));
//
