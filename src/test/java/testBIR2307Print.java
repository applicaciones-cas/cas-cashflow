...
import ph.com.guanzongroup.cas.cashflow.BIR2307Print;

@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class testBIR2307Print {

    static GRiderCAS poApp;
    static BIR2307Print poBIR2307Filler;
    ...
    public static void setUpClass() {
        try {
            ...
            poBIR2307Filler = new BIR2307Print();
    ...
    public void testOPenSource() {
        ...
        try {
            ...
            loList.add("GCO125000003");
            loJSON = poBIR2307Filler.openSource(loList);
            if (!"success".equals((String) loJSON.get("result"))) {
